...
def build_row(
    ...
    *,
    ...
    return TidyRow(
        ...
        decoy_capture=_clean(row.get("decoy_capture")),
        ...
        split_id=channel.split_id,
        gt_r_half=_clean(channel.meta.get("gt_r_half")),
        gt_reliability=_clean(channel.meta.get("gt_reliability")),
